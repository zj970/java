 ...
 * 
 */
@Controller("businessNoteCategoryController")
@RequestMapping("/business/note_category")
public class NoteCategoryController extends BaseController {
	...
	public String add(ModelMap model) {
		...
		return "business/note_category/add";
	}
	...
	public String edit(Long id, ModelMap model) {
		...
		return "business/note_category/edit";
	}
	...
	public String list(ModelMap model) {
		model.addAttribute("articleCategoryTree", articleCategoryService.findTree());
		return "business/note_category/list";
	}
