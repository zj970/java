...
public interface OrderDao extends BaseDao<Order> {
	 ...
	 * @return 订单
	 */
	List<Order> findList(@Param("ew")QueryWrapper<Order> queryWrapper, @Param("type")Order.Type type, @Param("status")Order.Status status, @Param("store")Store store, @Param("member")Member member, @Param("product")Product product, @Param("isPendingReceive")Boolean isPendingReceive, @Param("isPendingRefunds")Boolean isPendingRefunds, @Param("isExchangePoint")Boolean isExchangePoint, @Param("isAllocatedStock")Boolean isAllocatedStock, @Param("hasExpired")Boolean hasExpired, @Param("isRefund")Long isRefund);
	...
	void  updateIsRefund(@Param("order")Order  order);
}