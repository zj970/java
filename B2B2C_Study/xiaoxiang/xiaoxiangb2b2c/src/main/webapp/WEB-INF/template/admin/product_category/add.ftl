...
<head>
	...
	<title>${message("admin.productCategory.add")} - 小象电商</title>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-4">
								<input id="deductStock" name="deductStock" class="form-control" type="text" maxlength="9">
							</div>
						</div>
							...
							<div class="col-xs-9 col-sm-4">
								...
								<select name="categoryType" class="selectpicker form-control" data-live-search="true" data-size="10">
									[#list dictList as dict]
										<option value="${dict.dictId}" title="${dict.dictValue}">
											${dict.dictValue}
										</option>
									[/#list]
								</select>
						...
						<div class="form-group">
							...
							<div class="col-xs-9 col-sm-4">
								<input id="imgUrl" name="imgUrl" type="hidden"  data-provide="fileinput" data-file-type="IMAGE">
							</div>
						</div>
