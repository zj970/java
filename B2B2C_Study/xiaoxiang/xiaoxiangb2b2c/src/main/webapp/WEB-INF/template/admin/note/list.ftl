...
<body class="admin">
	...
	<main>
		<div class="container-fluid">
			...
			<form action="${base}/admin/note/list" method="get">
					...
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12 col-sm-9">
								<div class="btn-group">
									<a class="btn btn-default" href="${base}/admin/note/add" data-redirect-url="${base}/admin/note/list">
									...
									<tbody>
										[#list page.content as article]
											<tr>
												...
												<td>
													<a class="btn btn-default btn-xs btn-icon" href="${base}/admin/note/edit?id=${article.id}" title="${message("common.edit")}" data-toggle="tooltip" data-redirect-url>
