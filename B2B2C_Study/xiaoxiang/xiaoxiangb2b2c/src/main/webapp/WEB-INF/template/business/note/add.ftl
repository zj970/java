...
<head>
	...
	<title>${message("admin.article.add")} - 小象电商</title>
...
<body class="business">
	...
	<main>
		<div class="container-fluid">
			...
			<form id="articleForm" class="ajax-form form-horizontal" action="${base}/business/note/save" method="post">
					...
					<div class="panel-body">
						<div class="form-group" >
							...
							<div class="col-xs-9 col-sm-4">
								<input id="title" name="title" class="form-control" type="text" value="title" maxlength="200">
							</div>
						</div>
...
[#--							<label class="col-xs-3 col-sm-2 control-label" for="author">${message("Article.author")}:</label>--]
							<div class="col-xs-9 col-sm-4">
								<input id="author" name="author" class="form-control" type="hidden" maxlength="200">
							</div>
						</div>
						<div class="form-group">
[#--							<label class="col-xs-3 col-sm-2 control-label">${message("common.setting")}:</label>--]
							<div class="col-xs-9 col-sm-4" style="visibility: hidden">
...
[#--							<label class="col-xs-3 col-sm-2 control-label" for="seoTitle">${message("Article.seoTitle")}:</label>--]
							<div class="col-xs-9 col-sm-4">
								<input id="seoTitle" name="seoTitle" class="form-control" type="hidden" maxlength="200">
							</div>
						</div>
						<div class="form-group"  style="visibility: hidden">
[#--							<label class="col-xs-3 col-sm-2 control-label" for="seoKeywords">${message("Article.seoKeywords")}:</label>--]
							<div class="col-xs-9 col-sm-4">
								<input id="seoKeywords" name="seoKeywords" class="form-control" type="hidden" maxlength="200">
							</div>
						</div>
						<div class="form-group"  style="visibility: hidden">
[#--							<label class="col-xs-3 col-sm-2 control-label" for="seoDescription">${message("Article.seoDescription")}:</label>--]
							<div class="col-xs-9 col-sm-4">
								<input id="seoDescription" name="seoDescription" class="form-control" type="hidden" maxlength="200">
							</div>
						</div>
					</div>
